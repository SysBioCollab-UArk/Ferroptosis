...
#Rules
Parameter("k_Glu_intra",1.95e5)
Rule("Glu_Intra_Synthesis",None >> Glu_intra(),k_Glu_intra)

Parameter("k_Glu_extra",5)
...
Parameter("kcat_Glu_Cystine",1e-6)#1e-3
...
Parameter("kcat_Glu_Cys_GCL",1e-4)
